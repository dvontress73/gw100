class ZCL_ZGW100_COURSE_DPC definition
  public
...
protected section.
  ...
  methods BUSINESSPARTNERS_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW100_COURSE_MPC=>TS_BUSINESSPARTNER
    raising
  ...
  methods BUSINESSPARTNERS_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_COURSE_MPC=>TT_BUSINESSPARTNER
  ...
  methods PRODUCTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_COURSE_MPC=>TS_PRODUCT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRODUCTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_COURSE_MPC=>TT_PRODUCT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGW100_COURSE_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 21.09.2021 20:07:45 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_COURSE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_zgw100_course_mpc=>ts_product.
 DATA businesspartners_create_entity TYPE zcl_zgw100_course_mpc=>ts_businesspartner.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_zgw100_course_mpc=>ts_product.
 DATA businesspartners_get_entity TYPE zcl_zgw100_course_mpc=>ts_businesspartner.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_COURSE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_zgw100_course_mpc=>tt_product.
 DATA businesspartners_get_entityset TYPE zcl_zgw100_course_mpc=>tt_businesspartner.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_zgw100_course_mpc=>ts_product.
 DATA businesspartners_update_entity TYPE zcl_zgw100_course_mpc=>ts_businesspartner.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
