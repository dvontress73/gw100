class ZCL_ZGW100_COURSE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW100_COURSE_MPC=========CP' ##NO_TEXT.
...
CLASS ZCL_ZGW100_COURSE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW100_COURSE_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'BusinessPartner_Products' "#EC NOTEXT
                            iv_left_type        = 'BusinessPartner' "#EC NOTEXT
                            iv_right_type       = 'Product' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - BusinessPartner_Products
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'BusinessPartner_ProductsSet'                         "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_COURSE_MPC=>TS_BUSINESSPARTNER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210921200742'.                  "#EC NOTEXT
